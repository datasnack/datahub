...
env = environ.Env(
    ...
    DATAHUB_KEY=(str, ""),
    DATAHUB_FORGE=(str, ""),
    DATAHUB_FORGE_ISSUE_SHOW_ADD=(bool, True),
    DATAHUB_FORGE_ISSUE_TEMPLATES_PATH=(str, "/app/.forgejo/issue_template/"),
    DATAHUB_FORGE_ISSUE_TEMPLATES_REPO=(str, ".forgejo/issue_template/"),
...
DATAHUB_FORGE: str = env("DATAHUB_FORGE")
DATAHUB_FORGE_ISSUE_SHOW_ADD: bool = env("DATAHUB_FORGE_ISSUE_SHOW_ADD")
DATAHUB_FORGE_ISSUE_TEMPLATES_PATH = env("DATAHUB_FORGE_ISSUE_TEMPLATES_PATH")
DATAHUB_FORGE_ISSUE_TEMPLATES_REPO = env("DATAHUB_FORGE_ISSUE_TEMPLATES_REPO")
