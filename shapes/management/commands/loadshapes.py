...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        engine = create_engine(f"postgresql://{settings.DATABASES['default']['USER']}:{settings.DATABASES['default']['PASSWORD']}@{settings.DATABASES['default']['HOST']}:{settings.DATABASES['default']['PORT']}/{settings.DATABASES['default']['NAME']}")
        ...
        gdf_no_parent[['created_at', 'updated_at', 'id', 'name', 'type_id', 'properties', 'geometry']].to_postgis(Shape._meta.db_table, engine, if_exists='append')
        ...
        gdf_with_parent[['created_at', 'updated_at', 'id', 'name', 'type_id', 'parent_id', 'properties', 'geometry']].to_postgis(Shape._meta.db_table, engine, if_exists='append')
